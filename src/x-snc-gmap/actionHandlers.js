...
import { loadGoogleApi, initializeMap, updateMarkers, updateCircleLabel, updateInfoTemplate, toggleCircleVisibility, setPlace, handleDrawRoutes, handleToggleDistanceLines } from './loadGoogleMapsApi';
...
//     ...googleApiKeyActionHandlers,
     ...
     [customActions.DRAW_ROUTES]: handleDrawRoutes,

     [customActions.TOGGLE_DISTANCE_LINES]: handleToggleDistanceLines,
