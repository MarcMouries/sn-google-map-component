...
export const setMarkers = (state, updateState, dispatch, googleMap) => {
  ...
  let markers = mapMarkers.map((item) => {
    ...
    var svg2 = '<svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 27 43">' +
    ...
    var svg3 = '<svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0z"/><path d="M19 9A7 7 0 1 0 5 9c0 1.387.41 2.677 1.105 3.765h-.008C8.457 16.46 12 22 12 22l5.903-9.235h-.007A6.98 6.98 0 0 0 19 9zm-7 3a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/></svg>';

    var svg4 = 'data:image/svg+xml;utf-8, \
    ...
    //   path: "M13.5 0c-7.5 0-13.5 6-13.5 13.4 0 13.5 13.5 29.6 13.5 29.6s13.5-16.1 13.5-29.6c0-7.4-6-13.4-13.5-13.4z",
    //   fillColor: "green",
    //   fillOpacity: 0.6,
    //   strokeWeight: 0,
    //   scale: 0.5,
